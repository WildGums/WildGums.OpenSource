...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.NuGetExplorer) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.NuGetExplorer.svg)](https://www.nuget.org/packages/Orc.NuGetExplorer) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.NuGetExplorer.svg)](https://www.nuget.org/packages/Orc.NuGetExplorer) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.NuGetExplorer.svg)](https://www.nuget.org/packages/Orc.NuGetExplorer) |
