...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.Memento) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.Memento.svg)](https://www.nuget.org/packages/Orc.Memento) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.Memento.svg)](https://www.nuget.org/packages/Orc.Memento) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.Memento.svg)](https://www.nuget.org/packages/Orc.Memento) |
