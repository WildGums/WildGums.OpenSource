...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.FluentValidation) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.FluentValidation.svg)](https://www.nuget.org/packages/Orc.FluentValidation) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.FluentValidation.svg)](https://www.nuget.org/packages/Orc.FluentValidation) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.FluentValidation.svg)](https://www.nuget.org/packages/Orc.FluentValidation) |
