...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.Sort) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.Sort.svg)](https://www.nuget.org/packages/Orc.Sort) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.Sort.svg)](https://www.nuget.org/packages/Orc.Sort) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.Sort.svg)](https://www.nuget.org/packages/Orc.Sort) |
