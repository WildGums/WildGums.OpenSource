...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.SupportPackage) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.SupportPackage.svg)](https://www.nuget.org/packages/Orc.SupportPackage) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.SupportPackage.svg)](https://www.nuget.org/packages/Orc.SupportPackage) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.SupportPackage.svg)](https://www.nuget.org/packages/Orc.SupportPackage) |
