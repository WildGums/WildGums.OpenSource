...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.WorkspaceManagement) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.WorkspaceManagement.svg)](https://www.nuget.org/packages/Orc.WorkspaceManagement) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.WorkspaceManagement.svg)](https://www.nuget.org/packages/Orc.WorkspaceManagement) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.WorkspaceManagement.svg)](https://www.nuget.org/packages/Orc.WorkspaceManagement) |
