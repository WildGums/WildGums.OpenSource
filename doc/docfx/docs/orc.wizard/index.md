...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.Wizard) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.Wizard.svg)](https://www.nuget.org/packages/Orc.Wizard) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.Wizard.svg)](https://www.nuget.org/packages/Orc.Wizard) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.Wizard.svg)](https://www.nuget.org/packages/Orc.Wizard) |
