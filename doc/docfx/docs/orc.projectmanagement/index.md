...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.ProjectManagement) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.ProjectManagement.svg)](https://www.nuget.org/packages/Orc.ProjectManagement) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.ProjectManagement.svg)](https://www.nuget.org/packages/Orc.ProjectManagement) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.ProjectManagement.svg)](https://www.nuget.org/packages/Orc.ProjectManagement) |
