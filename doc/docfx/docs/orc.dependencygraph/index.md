...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.DependencyGraph) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.DependencyGraph.svg)](https://www.nuget.org/packages/Orc.DependencyGraph) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.DependencyGraph.svg)](https://www.nuget.org/packages/Orc.DependencyGraph) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.DependencyGraph.svg)](https://www.nuget.org/packages/Orc.DependencyGraph) |
