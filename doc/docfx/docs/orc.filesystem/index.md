...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.FileSystem) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.FileSystem.svg)](https://www.nuget.org/packages/Orc.FileSystem) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.FileSystem.svg)](https://www.nuget.org/packages/Orc.FileSystem) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.FileSystem.svg)](https://www.nuget.org/packages/Orc.FileSystem) |
