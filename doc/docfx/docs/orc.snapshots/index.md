...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.Snapshots) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.Snapshots.svg)](https://www.nuget.org/packages/Orc.Snapshots) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.Snapshots.svg)](https://www.nuget.org/packages/Orc.Snapshots) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.Snapshots.svg)](https://www.nuget.org/packages/Orc.Snapshots) |
