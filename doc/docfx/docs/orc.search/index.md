...
| | |
|-|-|
| Chat | [![Join the chat](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/WildGums/Orc.Search) |
| Downloads | [![NuGet downloads](https://img.shields.io/nuget/dt/Orc.Search.svg)](https://www.nuget.org/packages/Orc.Search) |
| Stable version | [![Stable version](https://img.shields.io/nuget/v/Orc.Search.svg)](https://www.nuget.org/packages/Orc.Search) |
| Unstable version | [![Unstable version](https://img.shields.io/nuget/vpre/Orc.Search.svg)](https://www.nuget.org/packages/Orc.Search) |
