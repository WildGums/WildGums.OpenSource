Orc.Prism offers a basic bootstrapper that uses the _ServiceLocator_ as IoC container. This way, it is really simple to create a prism application using Catel and prism.
